...
from main_app.utils import send_rental_key_email
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                send_rental_key_email(request.user.email, rental_key.code)
                ...
                messages.success(request, f"Игра '{game.name}' успешно арендована! Ключ отправлен на вашу почту.")

                return HttpResponseRedirect(reverse('cart:cart_detail') + f'?rental_price={rental_price}')
